...
const faqs = [
  {
    ...
    answer:
      "Pitchy.pro — это ваш ИИ-копилот для ведения бизнеса. Мы помогаем развивать проект на всех этапах его жизненного цикла, предоставляя инструменты для анализа и оптимизации.",
  },
  {
    question: "Какую помощь я могу получить?",
    answer:
      "Вы можете получить оценку 0-100 вашей идее стартапа, проанализировать вашу ЦА, рассчитать Юнит-экономику или просто вести свободный диалог с ИИ-агентом для получения советов и рекомендаций.",
  },
  {
