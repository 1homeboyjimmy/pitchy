...
export function SiteFooter() {
  return (
    <footer className="relative bg-black pt-24 pb-12 overflow-hidden section-line mt-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-12">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              ...
              <li><Link className="text-sm text-white/50 hover:text-white transition-colors font-sans font-medium tracking-tight whitespace-nowrap" href="/offer">Публичная оферта</Link></li>
              <li><Link className="text-sm text-white/50 hover:text-white transition-colors font-sans font-medium tracking-tight whitespace-nowrap" href="/terms">Условия использования</Link></li>
