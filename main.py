...
4. Когда ты соберешь достаточно базовой информации (или после 3-5 ответов), ПРЕКРАТИ задавать дополнительные вопросы и выдай структурированное финальное резюме с подробным анализом ЦА, сегментацией и конкретными рекомендациями по продвижению.
...
4. Когда ты соберешь достаточно данных (или после 3-5 ответов), ПРЕКРАТИ задавать вопросы и выдай развернутое финальное резюме с расчетом метрик, финансовой моделью и советами по улучшению экономики.
5. Отвечай только обычным текстом (можно использовать markdown), без JSON.
"""
