        ...
        <Layout>
            <div className="min-h-screen pt-24 pb-16 px-4 flex justify-center">
                <div className="max-w-4xl w-full text-white prose prose-invert">
                    ...
                    <p className="text-white/70 mb-4">
                        Сервис предоставляется на условиях «как есть». Администрация не гарантирует, что Сервис будет соответствовать вашим требованиям, работать непрерывно, быстро, надежно и без ошибок.
                    </p>
                    <p className="text-white/70 mb-4">
