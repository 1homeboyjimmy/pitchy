          ...
          >
            <div className="flex flex-col items-center justify-center h-full gap-2 pt-16">
              ...
              <motion.div
                ...
                className="mt-6 pt-6 border-t border-white/10 flex flex-col items-center gap-4 w-64"
              >
                {token ? (
                  <>
                    <Link
                    ...
                    <button
                      onClick={handleLogout}
                      className="w-full bg-white text-black px-4 py-3 font-mono-label text-[12px] uppercase tracking-widest font-bold hover:opacity-90 transition-opacity"
                    >
                      ВЫЙТИ
                    </button>
                  </>
