        ...
        <Layout>
            <div className="min-h-screen pt-24 pb-16 px-4 flex justify-center">
                <div className="max-w-4xl w-full text-white prose prose-invert">
                    ...
                    <h2 className="text-2xl font-semibold mt-8 mb-4">4. Fair Use Policy (Политика добросовестного использования)</h2>
                    <p className="text-white/70 mb-4">
                        "Безлимитный" доступ на тарифах предоставляется для целей добросовестного использования. Нарушением Fair Use Policy считаются:
                    </p>
                    ...
                    <p className="text-white/70 mb-4">
                        Сервис предоставляется на условиях «как есть» (AS IS). Администрация не гарантирует, что Сервис будет соответствовать вашим требованиям, работать непрерывно, быстро, надежно и без ошибок.
                    </p>
                    <p className="text-white/70 mb-4">
