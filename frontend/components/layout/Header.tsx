                            ...
                            {isAuthed ? (
                                <>
                                    ...
                                    <button
                                        ...
                                        className="font-mono-label text-[10px] uppercase tracking-widest text-neutral-500 hover:text-white hover:bg-zinc-800/50 rounded-lg px-3 py-2 transition-colors"
                                    >
                                        ВЫЙТИ
                                    </button>
                                </>
