...
const LABELS: Record<string, string> = {
  ...
  "artifact.launched": "Запущено действие Pitchy", "artifact.synced": "Обновлён статус результата Pitchy", "artifact.updated": "Обновлены описание и доступ к результату", "artifact.unlinked": "Результат отвязан от этапа",
};
