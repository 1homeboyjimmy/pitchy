                    ...
                    <div>
                        ...
                        {trend && (
                            <div className="mt-2 flex items-center gap-1">
                                <span
                                    className={`text-xs font-medium ${trend.isPositive ? "text-emerald-400" : "text-red-400"
                                        }`}
                                >
                                    {trend.isPositive ? "+" : ""}
                                    {trend.value}%
                                </span>
                                <span className="text-xs text-white/40">за месяц</span>
                            </div>
                        )}
                    </div>

                    <div className="p-3 rounded-xl" style={{ background: colors.border }}>
