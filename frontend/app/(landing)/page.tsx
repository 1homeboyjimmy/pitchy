    ...
    <div className="antialiased min-h-screen flex flex-col overflow-x-hidden" style={{ backgroundColor: "#0A0A0A", color: "#ffffff" }}>
      ...
      <main className="flex-grow w-full max-w-[1440px] mx-auto px-4 md:px-12 py-12 space-y-32">
        ...
        <section className="relative w-full min-h-[80vh] flex flex-col justify-center items-center text-center">
          ...
          <div className="relative z-10 bg-black/40 backdrop-blur-[2px] p-8 rounded-2xl">
        ...
        <section className="py-24 border-t border-white/[0.08]">
          <div className="max-w-6xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="bg-[#111111] border border-white/10 rounded-lg overflow-hidden shadow-2xl flex flex-col h-[400px]">
        ...
        <section className="py-24 border-t border-white/[0.08] relative overflow-hidden">
          <div className="text-center mb-16"><h2 className="text-[32px] md:text-[40px] leading-tight font-semibold tracking-tight mb-6">Автоматизация грантового цикла</h2><p className="text-neutral-400 text-sm font-mono">SCAN_FUNDS // DYNAMIC_TRACK_ENGAGED</p></div>
          <div className="relative w-full max-w-5xl mx-auto px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
              {["ПОДАЧА", "ТРЕКШН", "ОТЧЕТНОСТЬ"].map((label, i) => (
                <div key={label} className="group border border-white/10 bg-[#0e0e0e]/80 backdrop-blur-sm p-6 rounded-lg transition-all duration-300 hover:-translate-y-2 hover:border-white/20 cursor-crosshair">
        ...
        {/* Deep CustDev */}
        <section className="py-24 border-t border-white/[0.08]">
          <div className="max-w-4xl mx-auto text-center mb-24"><h2 className="text-[40px] md:text-[56px] leading-tight font-semibold tracking-tight mb-6">Deep CustDev: Синтетические интервью</h2><p className="text-neutral-400 text-lg">Множество ИИ-агентов в реальном времени дают обратную связь по вашему проекту. Каждому агенту заданы личные характеристики.</p></div>
          <div className="relative w-full max-w-6xl mx-auto bg-[#111111] border border-white/10 rounded-lg p-8">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
              {agents.map((a) => (
                <div key={a.role} className="bg-[#1A1A1A] border border-white/10 p-4 rounded-lg shadow-xl hover:border-white/40 transition-colors flex flex-col h-full">
        ...
        {/* Roadmap */}
        <section className="py-24 border-t border-white/[0.08]">
          <div className="max-w-4xl mx-auto text-center mb-24"><h2 className="text-[40px] md:text-[56px] leading-tight font-semibold tracking-tight mb-6">Структурированная дорожная карта проекта.</h2></div>
          <div className="relative w-full max-w-5xl mx-auto h-[400px] border border-white/5 rounded-lg bg-[#0A0A0A] p-8 overflow-hidden">
        ...
        <section className="py-24 border-t border-white/[0.08]">
          <div className="max-w-6xl mx-auto px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {features.map((f) => (
                <div key={f.title} className="bg-[#111111] border border-white/10 p-8 rounded-xl hover:border-white/20 transition-colors">
        ...
        <section className="py-24 border-t border-white/[0.08]">
          <div className="max-w-3xl mx-auto px-8">
            ...
            <div className="space-y-4">
              {faqItems.map((faq) => (
                <details key={faq.q} className="bg-[#111111] border border-white/10 rounded-lg group" name="faq">
