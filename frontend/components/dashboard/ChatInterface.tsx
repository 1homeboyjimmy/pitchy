                                        ...
                                        <div
                                            ...
                                            <ReactMarkdown 
                                                ...
                                                components={{
                                                    ...
                                                    // `w-max min-w-full` lets the table keep its natural
                                                    // column widths and overflow the bubble instead of
                                                    // being squeezed into unreadable columns on a phone —
                                                    // the wrapper scrolls it sideways (see .pitchy-table-scroll).
                                                    table: ({...props}) => (
