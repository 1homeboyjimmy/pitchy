...
resolve_from_lockbox "CUSTDEV_SSO_SERVICE_SECRET" "LOCKBOX_CUSTDEV_SSO_SERVICE_SECRET_SECRET_ID" "LOCKBOX_CUSTDEV_SSO_SERVICE_SECRET_ENTRY_KEY"
resolve_from_lockbox "YC_API_KEY" "LOCKBOX_YC_API_KEY_SECRET_ID" "LOCKBOX_YC_API_KEY_ENTRY_KEY"
resolve_from_lockbox "EXA_API_KEY" "LOCKBOX_EXA_API_KEY_SECRET_ID" "LOCKBOX_EXA_API_KEY_ENTRY_KEY"
