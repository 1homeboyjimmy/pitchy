...
const faqs = [
  ...
  },
  {
    ...
    answer: "AI-скоринг стартапов — это процесс автоматической оценки бизнес-идеи, команды и рыночных перспектив с использованием больших языковых моделей (LLM) для предсказания инвестиционной привлекательности проекта по шкале от 0 до 100.",
  },
  {
    question: "Какую помощь я могу получить?",
    answer:
      "Вы можете получить оценку 0-100 вашей идее стартапа, проанализировать вашу ЦА, рассчитать Юнит-экономику или просто вести свободный диалог с ИИ-агентом для получения советов.",
  },
  {
    question: "Это бесплатно?",
    answer:
      "Да, по условиям базового тарифа у вас есть возможность бесплатно анализировать 1 проект. Премиум-функции, такие как детальные отчёты и сравнение, большее количество проектов, генерация структуры презентации и возможность экспорта в PDF и TXT отчетов анализа, доступны в платных тарифах.",
  },
  {
